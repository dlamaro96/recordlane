...
const routes=['overview','models','sources','records','entities','master','matches','survivorship','inbox','corrections','quality','simulator','operations','relationships','access'];
await mkdir(output,{recursive:true});
const browser=await chromium.launch(); const page=await browser.newPage({viewport:{width:1440,height:900},colorScheme:'light'});
