...
Updated: 2026-09-10. Scope: Recordlane 0.1.0-alpha.3 source, default and production Compose profiles, and Helm packaging. This is an engineering threat model, not a certification.
