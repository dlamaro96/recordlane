...
def test_governed_merge_and_split_preserve_evidence_and_create_repair():
    ...
    with TestClient(app) as client:
        ...
        preview = client.post(
            ...
            headers=steward,
            json={"entity_ids": ids, "reason": "Preview related contribution impact"},
        )
        ...
        proposed = client.post(
            "/api/v1/merges",
            headers=steward,
            json={"entity_ids": ids, "reason": "Synthetic correction test"},
        )
        ...
        split = client.post(
            f"/api/v1/entities/{ids[0]}/splits",
            headers=steward,
            json={
                "source_record_ids": [moved],
                "reason": "Contribution belongs to a distinct supplier",
            },
        )
